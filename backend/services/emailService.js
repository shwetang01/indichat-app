...
const sendOtpToEmail = async(email,otp)=>{
    ...
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
      ...
      <p>Your one-time password (OTP) to verify your IndichatApp Web account is:</p>
      ...
      <p style="margin-top: 20px;">Thanks & Regards,<br/>IndiChatApp Web Security Team</p>
 ...
 await transporter.sendMail({
    from:`Indichat web<{process.env,EMAIL_USER}`,
    to:email,
